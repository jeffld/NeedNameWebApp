...
namespace NeedNameWebApp
{
    public partial class ViewMember : System.Web.UI.Page
    {
        ...
        {
            // Get parameter
            var sMemberID = Request.QueryString["memberid"];
            int iMemberID = Convert.ToInt32(sMemberID);
            ...
            string SQL = "select * from nnMemberContractors where MemberID=" + sMemberID;
        ...
        private void PopulateData(int pageNo, int noOfRecord, int iMemberID)
        {
            ...
            {
                SqlCommand cmd = new SqlCommand("sp_nn_getMemberSkillsData", con);
                cmd.CommandType = System.Data.CommandType.StoredProcedure;
                cmd.Parameters.AddWithValue("@PageNo", pageNo);
                cmd.Parameters.AddWithValue("@MemberID", iMemberID);
        ...
        protected void b_click(object sender, EventArgs e)
        {
            ...
            PopulateData(Convert.ToInt32(pageNo), 5,Convert.ToInt32(memberID.Text));
        }
